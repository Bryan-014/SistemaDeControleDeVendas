<?php
  ...
  $product = mysqli_fetch_assoc(mysqli_query($connection, "select * from tbl_produtos where cod = ".$code));
?>
<div class="prod-container mt-3">
  ...
  <form action="./assets/php/prod/edit.php" method="post">
    <div class="d-flex">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <a href="./assets/php/prod/del.php?id=<?php echo($code)?>" class="btn bt-primary m-1">Excluir</a>
      </div>
    </div>
  </div>
</div>
